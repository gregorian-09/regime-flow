...
namespace regimeflow::data
{
    ...
    public:
         ...
         */
        [[nodiscard]] Result<std::string> list_assets(const std::string& status = "active",
         ...
         */
        [[nodiscard]] Result<std::string> get_bars(const std::vector<std::string>& symbols,
         ...
         * @param page_token Optional pagination token.
         */
        [[nodiscard]] Result<std::string> get_trades(const std::vector<std::string>& symbols,
                                       const std::string& start,
                                       const std::string& end,
                                       int limit = 0,
                                       const std::string& page_token = "") const;
    ...
    private:
        [[nodiscard]] Result<std::string> rest_get(const std::string& base_url,
