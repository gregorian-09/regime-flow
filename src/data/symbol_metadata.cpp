...
namespace regimeflow::data
{
    namespace {
        ...
        void merge_metadata(SymbolInfo& info, const SymbolMetadata& metadata, const bool overwrite) {
    ...
    SymbolMetadataMap load_symbol_metadata_csv(const std::string& path,
        ...
        if (std::string header_line; has_header && std::getline(file, header_line)) {
