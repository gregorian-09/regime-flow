...
void TestCppClient::orderOperations()
{
	...
	OrderId orderId = m_orderId++;
	OrderId slOrderId = m_orderId++;
	OrderId ptOrderId = m_orderId++;
...
void TestCppClient::openOrder( OrderId orderId, const Contract& contract, const Order& order, const OrderState& orderState) {
    printf( "OpenOrder. PermId: %s, ClientId: %s, OrderId: %s, Account: %s, Symbol: %s, SecType: %s, Exchange: %s:, Strike: %s, Action: %s, OrderType:%s, TotalQty: %s, CashQty: %s, "
        ...
        "Submitter: %s, ImbalanceOnly: %s, PostOnly: %s, AllowPreOpen: %s, IgnoreOpenAuction: %s, Deactivate: %s, ActiveStartTime: %s, ActiveStopTime: %s, SeekPriceImprovement: %s, "
        "RouteMarketableToBbo: %s\n",
        ...
        order.submitter.c_str(), (order.imbalanceOnly ? "true" : "false"), (order.postOnly ? "true" : "false"), (order.allowPreOpen ? "true" : "false"), (order.ignoreOpenAuction ? "true" : "false"),
		(order.deactivate ? "true" : "false"), order.activeStartTime.c_str(), order.activeStopTime.c_str(), (order.seekPriceImprovement == ThreeStateBoolean::STATE_YES ? "true" : "false"),
		(order.routeMarketableToBbo == ThreeStateBoolean::STATE_YES ? "true" : "false"));
	...
	if (order.whatIf) {
		printf("WhatIf. Status: %s, WhatIfType: %d, InitMarginBefore: %s, MaintMarginBefore: %s, EquityWithLoanBefore: %s, "
