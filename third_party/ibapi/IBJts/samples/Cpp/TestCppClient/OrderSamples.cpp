...
OrderCondition* OrderSamples::Price_Condition(int conId, std::string exchange, double price, PriceCondition::Method triggerMethod, bool isMore, bool isConjunction){
	//! [price_condition]
...
Order OrderSamples::LimitOnCloseOrderWithImbalanceOnly(std::string action, Decimal quantity, double limitPrice) {
...
Order OrderSamples::LimitOrderWithStopLossAndProfitTaker(std::string action, Decimal quantity, double limitPrice, int slOrderId, int ptOrderId) {
