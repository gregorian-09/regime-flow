...
PROTOBUF_CONSTEXPR OrderStatus::OrderStatus(
  ...
  , /*decltype(_impl_.filled_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.remaining_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.whyheld_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_OrderStatus_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_OrderStatus_2eproto = nullptr;

const uint32_t TableStruct_OrderStatus_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 17, -1, sizeof(::protobuf::OrderStatus)},
};
...
const char descriptor_table_protodef_OrderStatus_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_OrderStatus_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_OrderStatus_2eproto = {
    false, false, 520, descriptor_table_protodef_OrderStatus_2eproto,
    "OrderStatus.proto",
    &descriptor_table_OrderStatus_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_OrderStatus_2eproto::offsets,
    file_level_metadata_OrderStatus_2eproto, file_level_enum_descriptors_OrderStatus_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_OrderStatus_2eproto(&descriptor_table_OrderStatus_2eproto);
namespace protobuf {
...
OrderStatus::OrderStatus(const OrderStatus& from)
  ...
  if (from._internal_has_filled()) {
    _this->_impl_.filled_.Set(from._internal_filled(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_remaining()) {
    _this->_impl_.remaining_.Set(from._internal_remaining(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_whyheld()) {
    _this->_impl_.whyheld_.Set(from._internal_whyheld(), 
      _this->GetArenaForAllocation());
  }
...
uint8_t* OrderStatus::_InternalSerialize(
  ...
  if (_internal_has_avgfillprice()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(5, this->_internal_avgfillprice(), target);
  }

  // optional int64 permId = 6;
  if (_internal_has_permid()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(6, this->_internal_permid(), target);
  }

  // optional int32 parentId = 7;
  if (_internal_has_parentid()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(7, this->_internal_parentid(), target);
  }

  // optional double lastFillPrice = 8;
  if (_internal_has_lastfillprice()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(8, this->_internal_lastfillprice(), target);
  }

  // optional int32 clientId = 9;
  if (_internal_has_clientid()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(9, this->_internal_clientid(), target);
  }
  ...
  if (_internal_has_mktcapprice()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(11, this->_internal_mktcapprice(), target);
  }
...
void OrderStatus::InternalSwap(OrderStatus* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.filled_, lhs_arena,
      &other->_impl_.filled_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.remaining_, lhs_arena,
      &other->_impl_.remaining_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.whyheld_, lhs_arena,
