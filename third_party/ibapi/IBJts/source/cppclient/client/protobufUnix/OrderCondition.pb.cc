...
struct OrderConditionDefaultTypeInternal {
  PROTOBUF_CONSTEXPR OrderConditionDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 OrderConditionDefaultTypeInternal _OrderCondition_default_instance_;
}  // namespace protobuf
static ::_pb::Metadata file_level_metadata_OrderCondition_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_OrderCondition_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_OrderCondition_2eproto = nullptr;
...
const char descriptor_table_protodef_OrderCondition_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_OrderCondition_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_OrderCondition_2eproto = {
    false, false, 597, descriptor_table_protodef_OrderCondition_2eproto,
    ...
    file_level_metadata_OrderCondition_2eproto, file_level_enum_descriptors_OrderCondition_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_OrderCondition_2eproto(&descriptor_table_OrderCondition_2eproto);
namespace protobuf {
...
uint8_t* OrderCondition::_InternalSerialize(
  ...
  if (_internal_has_isconjunctionconnection()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(2, this->_internal_isconjunctionconnection(), target);
  }

  // optional bool isMore = 3;
  if (_internal_has_ismore()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(3, this->_internal_ismore(), target);
  }
  ...
  if (_internal_has_percent()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(8, this->_internal_percent(), target);
  }

  // optional double changePercent = 9;
  if (_internal_has_changepercent()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(9, this->_internal_changepercent(), target);
  }
  ...
  if (_internal_has_triggermethod()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(11, this->_internal_triggermethod(), target);
  }
  ...
  if (_internal_has_volume()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(13, this->_internal_volume(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:protobuf.OrderCondition)
  ...
  if (cached_has_bits & 0x00001f00u) {
    ...
    if (cached_has_bits & 0x00000800u) {
      total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_triggermethod());
    }
