...
PROTOBUF_CONSTEXPR ExecutionFilter::ExecutionFilter(
  ...
  , /*decltype(_impl_._specificdates_cached_byte_size_)*/{0}
...
struct ExecutionFilterDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ExecutionFilterDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ExecutionFilterDefaultTypeInternal _ExecutionFilter_default_instance_;
}  // namespace protobuf
static ::_pb::Metadata file_level_metadata_ExecutionFilter_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_ExecutionFilter_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_ExecutionFilter_2eproto = nullptr;

const uint32_t TableStruct_ExecutionFilter_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 15, -1, sizeof(::protobuf::ExecutionFilter)},
};
...
const char descriptor_table_protodef_ExecutionFilter_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ".protobufb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_ExecutionFilter_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_ExecutionFilter_2eproto = {
    false, false, 417, descriptor_table_protodef_ExecutionFilter_2eproto,
    "ExecutionFilter.proto",
    &descriptor_table_ExecutionFilter_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_ExecutionFilter_2eproto::offsets,
    file_level_metadata_ExecutionFilter_2eproto, file_level_enum_descriptors_ExecutionFilter_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_ExecutionFilter_2eproto(&descriptor_table_ExecutionFilter_2eproto);
namespace protobuf {
...
inline void ExecutionFilter::SharedCtor(
...
uint8_t* ExecutionFilter::_InternalSerialize(
  ...
  if (_internal_has_lastndays()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(8, this->_internal_lastndays(), target);
  }

  // repeated int32 specificDates = 9;
  {
    int byte_size = _impl_._specificdates_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
...
// @@protoc_insertion_point(message_byte_size_start:protobuf.ExecutionFilter)
  ...
  // repeated int32 specificDates = 9;
  {
    size_t data_size = ::_pbi::WireFormatLite::
      Int32Size(this->_impl_.specificdates_);
    if (data_size > 0) {
      total_size += 1 +
        ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
    }
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._specificdates_cached_byte_size_.store(cached_size,
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000080u) {
      total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_lastndays());
    }
