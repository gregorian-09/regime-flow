...
class HistoricalTicks final :
 ...
 public:
  ...
  ~HistoricalTicks() override;
  explicit PROTOBUF_CONSTEXPR HistoricalTicks(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  HistoricalTicks* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const HistoricalTicks& from) {
    HistoricalTicks::MergeImpl(*this, from);
  }
  private:
...
inline int32_t HistoricalTicks::_internal_reqid() const {
  return _impl_.reqid_;
}
inline int32_t HistoricalTicks::reqid() const {
  // @@protoc_insertion_point(field_get:protobuf.HistoricalTicks.reqId)
  return _internal_reqid();
}
inline void HistoricalTicks::_internal_set_reqid(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.reqid_ = value;
}
inline void HistoricalTicks::set_reqid(int32_t value) {
...
inline int HistoricalTicks::_internal_historicalticks_size() const {
  return _impl_.historicalticks_.size();
}
...
inline ::protobuf::HistoricalTick* HistoricalTicks::mutable_historicalticks(int index) {
  ...
  return _impl_.historicalticks_.Mutable(index);
}
...
inline ::protobuf::HistoricalTick* HistoricalTicks::_internal_add_historicalticks() {
  return _impl_.historicalticks_.Add();
}
inline ::protobuf::HistoricalTick* HistoricalTicks::add_historicalticks() {
  ::protobuf::HistoricalTick* _add = _internal_add_historicalticks();
