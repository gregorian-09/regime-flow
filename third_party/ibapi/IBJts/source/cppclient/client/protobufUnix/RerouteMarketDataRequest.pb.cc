...
namespace protobuf {
PROTOBUF_CONSTEXPR RerouteMarketDataRequest::RerouteMarketDataRequest(
...
struct RerouteMarketDataRequestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RerouteMarketDataRequestDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RerouteMarketDataRequestDefaultTypeInternal _RerouteMarketDataRequest_default_instance_;
}  // namespace protobuf
static ::_pb::Metadata file_level_metadata_RerouteMarketDataRequest_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_RerouteMarketDataRequest_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_RerouteMarketDataRequest_2eproto = nullptr;

const uint32_t TableStruct_RerouteMarketDataRequest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::protobuf::RerouteMarketDataRequest, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::protobuf::RerouteMarketDataRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::protobuf::RerouteMarketDataRequest, _impl_.reqid_),
  PROTOBUF_FIELD_OFFSET(::protobuf::RerouteMarketDataRequest, _impl_.conid_),
  PROTOBUF_FIELD_OFFSET(::protobuf::RerouteMarketDataRequest, _impl_.exchange_),
  1,
  2,
  0,
};
...
static const ::_pb::Message* const file_default_instances[] = {
  &::protobuf::_RerouteMarketDataRequest_default_instance_._instance,
};
...
const char descriptor_table_protodef_RerouteMarketDataRequest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_RerouteMarketDataRequest_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_RerouteMarketDataRequest_2eproto = {
    false, false, 248, descriptor_table_protodef_RerouteMarketDataRequest_2eproto,
    ...
    file_level_metadata_RerouteMarketDataRequest_2eproto, file_level_enum_descriptors_RerouteMarketDataRequest_2eproto,
    file_level_service_descriptors_RerouteMarketDataRequest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_RerouteMarketDataRequest_2eproto_getter() {
  return &descriptor_table_RerouteMarketDataRequest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_RerouteMarketDataRequest_2eproto(&descriptor_table_RerouteMarketDataRequest_2eproto);
namespace protobuf {
...
class RerouteMarketDataRequest::_Internal {
 public:
  using HasBits = decltype(std::declval<RerouteMarketDataRequest>()._impl_._has_bits_);
...
RerouteMarketDataRequest::RerouteMarketDataRequest(const RerouteMarketDataRequest& from)
  ...
  RerouteMarketDataRequest* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
const char* RerouteMarketDataRequest::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "protobuf.RerouteMarketDataRequest.exchange"));
        } else
          goto handle_unusual;
        continue;
      default:
...
void RerouteMarketDataRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RerouteMarketDataRequest*>(&to_msg);
  auto& from = static_cast<const RerouteMarketDataRequest&>(from_msg);
...
void RerouteMarketDataRequest::InternalSwap(RerouteMarketDataRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RerouteMarketDataRequest, _impl_.conid_)
      + sizeof(RerouteMarketDataRequest::_impl_.conid_)
      - PROTOBUF_FIELD_OFFSET(RerouteMarketDataRequest, _impl_.reqid_)>(
...
template<> PROTOBUF_NOINLINE ::protobuf::RerouteMarketDataRequest*
Arena::CreateMaybeMessage< ::protobuf::RerouteMarketDataRequest >(Arena* arena) {
