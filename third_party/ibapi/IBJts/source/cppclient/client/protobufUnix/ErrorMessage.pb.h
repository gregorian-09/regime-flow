...
class ErrorMessage final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_advancedorderrejectjson(ArgT0&& arg0, ArgT... args);
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_advancedorderrejectjson(const std::string& value);
...
void ErrorMessage::set_errormsg(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ErrorMessage::set_advancedorderrejectjson(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.advancedorderrejectjson_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* ErrorMessage::release_advancedorderrejectjson() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.advancedorderrejectjson_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void ErrorMessage::set_allocated_advancedorderrejectjson(std::string* advancedorderrejectjson) {
  ...
  _impl_.advancedorderrejectjson_.SetAllocated(advancedorderrejectjson, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.advancedorderrejectjson_.IsDefault()) {
    _impl_.advancedorderrejectjson_.Set("", GetArenaForAllocation());
  }
