...
PROTOBUF_CONSTEXPR ErrorMessage::ErrorMessage(
  ...
  , /*decltype(_impl_.advancedorderrejectjson_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
const ::_pbi::DescriptorTable descriptor_table_ErrorMessage_2eproto = {
    false, false, 319, descriptor_table_protodef_ErrorMessage_2eproto,
    "ErrorMessage.proto",
...
ErrorMessage::ErrorMessage(const ErrorMessage& from)
  ...
  if (from._internal_has_advancedorderrejectjson()) {
    _this->_impl_.advancedorderrejectjson_.Set(from._internal_advancedorderrejectjson(), 
      _this->GetArenaForAllocation());
  }
...
uint8_t* ErrorMessage::_InternalSerialize(
  ...
  if (_internal_has_errortime()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(2, this->_internal_errortime(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:protobuf.ErrorMessage)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      total_size += ::_pbi::WireFormatLite::Int64SizePlusOne(this->_internal_errortime());
    }
...
void ErrorMessage::InternalSwap(ErrorMessage* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.advancedorderrejectjson_, lhs_arena,
