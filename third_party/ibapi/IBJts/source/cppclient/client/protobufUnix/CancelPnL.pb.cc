...
namespace protobuf {
PROTOBUF_CONSTEXPR CancelPnL::CancelPnL(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.reqid_)*/0} {}
struct CancelPnLDefaultTypeInternal {
  PROTOBUF_CONSTEXPR CancelPnLDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CancelPnLDefaultTypeInternal _CancelPnL_default_instance_;
}  // namespace protobuf
static ::_pb::Metadata file_level_metadata_CancelPnL_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_CancelPnL_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_CancelPnL_2eproto = nullptr;

const uint32_t TableStruct_CancelPnL_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::protobuf::CancelPnL, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::protobuf::CancelPnL, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::protobuf::CancelPnL, _impl_.reqid_),
  0,
};
...
static const ::_pb::Message* const file_default_instances[] = {
  &::protobuf::_CancelPnL_default_instance_._instance,
};

const char descriptor_table_protodef_CancelPnL_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017CancelPnL.proto\022\010protobuf\")\n\tCancelPnL"
  "\022\022\n\005reqId\030\001 \001(\005H\000\210\001\001B\010\n\006_reqIdB9\n\026com.ib"
  ".client.protobufB\016CancelPnLProto\252\002\016IBApi"
  ".protobufb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_CancelPnL_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_CancelPnL_2eproto = {
    false, false, 137, descriptor_table_protodef_CancelPnL_2eproto,
    "CancelPnL.proto",
    &descriptor_table_CancelPnL_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_CancelPnL_2eproto::offsets,
    file_level_metadata_CancelPnL_2eproto, file_level_enum_descriptors_CancelPnL_2eproto,
    file_level_service_descriptors_CancelPnL_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_CancelPnL_2eproto_getter() {
  return &descriptor_table_CancelPnL_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_CancelPnL_2eproto(&descriptor_table_CancelPnL_2eproto);
namespace protobuf {
...
class CancelPnL::_Internal {
 public:
  using HasBits = decltype(std::declval<CancelPnL>()._impl_._has_bits_);
...
CancelPnL::CancelPnL(const CancelPnL& from)
  ...
  CancelPnL* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
const char* CancelPnL::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* CancelPnL::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:protobuf.CancelPnL)
  return target;
}

size_t CancelPnL::ByteSizeLong() const {
...
void CancelPnL::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<CancelPnL*>(&to_msg);
  auto& from = static_cast<const CancelPnL&>(from_msg);
...
// @@protoc_insertion_point(class_specific_copy_from_start:protobuf.CancelPnL)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool CancelPnL::IsInitialized() const {
  return true;
}
...
template<> PROTOBUF_NOINLINE ::protobuf::CancelPnL*
Arena::CreateMaybeMessage< ::protobuf::CancelPnL >(Arena* arena) {
  return Arena::CreateMessageInternal< ::protobuf::CancelPnL >(arena);
}
