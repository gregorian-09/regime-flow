...
void OrderAllocation::set_positiondesired(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
 _impl_.positiondesired_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* OrderAllocation::release_positiondesired() {
  ...
  _impl_._has_bits_[0] &= ~0x00000004u;
  auto* p = _impl_.positiondesired_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void OrderAllocation::set_allocated_positiondesired(std::string* positiondesired) {
  ...
  _impl_.positiondesired_.SetAllocated(positiondesired, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.positiondesired_.IsDefault()) {
    _impl_.positiondesired_.Set("", GetArenaForAllocation());
  }
...
void OrderAllocation::set_positionafter(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000008u;
 _impl_.positionafter_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* OrderAllocation::release_positionafter() {
  ...
  _impl_._has_bits_[0] &= ~0x00000008u;
  auto* p = _impl_.positionafter_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void OrderAllocation::set_allocated_positionafter(std::string* positionafter) {
  ...
  _impl_.positionafter_.SetAllocated(positionafter, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.positionafter_.IsDefault()) {
    _impl_.positionafter_.Set("", GetArenaForAllocation());
  }
...
void OrderAllocation::set_desiredallocqty(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000010u;
 _impl_.desiredallocqty_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* OrderAllocation::release_desiredallocqty() {
  ...
  _impl_._has_bits_[0] &= ~0x00000010u;
  auto* p = _impl_.desiredallocqty_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void OrderAllocation::set_allocated_desiredallocqty(std::string* desiredallocqty) {
  ...
  _impl_.desiredallocqty_.SetAllocated(desiredallocqty, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.desiredallocqty_.IsDefault()) {
    _impl_.desiredallocqty_.Set("", GetArenaForAllocation());
  }
...
void OrderAllocation::set_allowedallocqty(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000020u;
 _impl_.allowedallocqty_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* OrderAllocation::release_allowedallocqty() {
  ...
  _impl_._has_bits_[0] &= ~0x00000020u;
  auto* p = _impl_.allowedallocqty_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void OrderAllocation::set_allocated_allowedallocqty(std::string* allowedallocqty) {
  ...
  _impl_.allowedallocqty_.SetAllocated(allowedallocqty, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.allowedallocqty_.IsDefault()) {
    _impl_.allowedallocqty_.Set("", GetArenaForAllocation());
  }
