...
PROTOBUF_CONSTEXPR Execution::Execution(
  ...
  , /*decltype(_impl_.acctnumber_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  ...
  , /*decltype(_impl_.shares_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.cumqty_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_Execution_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_Execution_2eproto = nullptr;

const uint32_t TableStruct_Execution_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 27, -1, sizeof(::protobuf::Execution)},
};
...
const char descriptor_table_protodef_Execution_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_Execution_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_Execution_2eproto = {
    false, false, 912, descriptor_table_protodef_Execution_2eproto,
    "Execution.proto",
    &descriptor_table_Execution_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_Execution_2eproto::offsets,
    file_level_metadata_Execution_2eproto, file_level_enum_descriptors_Execution_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_Execution_2eproto(&descriptor_table_Execution_2eproto);
namespace protobuf {
...
Execution::Execution(const Execution& from)
  ...
  if (from._internal_has_acctnumber()) {
    _this->_impl_.acctnumber_.Set(from._internal_acctnumber(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_shares()) {
    _this->_impl_.shares_.Set(from._internal_shares(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_cumqty()) {
    _this->_impl_.cumqty_.Set(from._internal_cumqty(), 
      _this->GetArenaForAllocation());
  }
...
uint8_t* Execution::_InternalSerialize(
  ...
  if (_internal_has_permid()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(9, this->_internal_permid(), target);
  }
  ...
  if (_internal_has_isliquidation()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(11, this->_internal_isliquidation(), target);
  }
  ...
  if (_internal_has_avgprice()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(13, this->_internal_avgprice(), target);
  }
  ...
  if (_internal_has_lastliquidity()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(18, this->_internal_lastliquidity(), target);
  }

  // optional bool isPriceRevisionPending = 19;
  if (_internal_has_ispricerevisionpending()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(19, this->_internal_ispricerevisionpending(), target);
  }
  ...
  if (_internal_has_optexerciseorlapsetype()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(21, this->_internal_optexerciseorlapsetype(), target);
  }
...
void Execution::InternalSwap(Execution* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.shares_, lhs_arena,
      &other->_impl_.shares_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.cumqty_, lhs_arena,
