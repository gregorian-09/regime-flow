...
namespace protobuf {
PROTOBUF_CONSTEXPR CancelScannerSubscription::CancelScannerSubscription(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.reqid_)*/0} {}
struct CancelScannerSubscriptionDefaultTypeInternal {
  PROTOBUF_CONSTEXPR CancelScannerSubscriptionDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CancelScannerSubscriptionDefaultTypeInternal _CancelScannerSubscription_default_instance_;
}  // namespace protobuf
static ::_pb::Metadata file_level_metadata_CancelScannerSubscription_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_CancelScannerSubscription_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_CancelScannerSubscription_2eproto = nullptr;

const uint32_t TableStruct_CancelScannerSubscription_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::protobuf::CancelScannerSubscription, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::protobuf::CancelScannerSubscription, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::protobuf::CancelScannerSubscription, _impl_.reqid_),
  0,
};
...
static const ::_pb::Message* const file_default_instances[] = {
  &::protobuf::_CancelScannerSubscription_default_instance_._instance,
};

const char descriptor_table_protodef_CancelScannerSubscription_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\037CancelScannerSubscription.proto\022\010proto"
  "buf\"9\n\031CancelScannerSubscription\022\022\n\005reqI"
  "d\030\001 \001(\005H\000\210\001\001B\010\n\006_reqIdBI\n\026com.ib.client."
  "protobufB\036CancelScannerSubscriptionProto"
  "\252\002\016IBApi.protobufb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_CancelScannerSubscription_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_CancelScannerSubscription_2eproto = {
    false, false, 185, descriptor_table_protodef_CancelScannerSubscription_2eproto,
    ...
    file_level_metadata_CancelScannerSubscription_2eproto, file_level_enum_descriptors_CancelScannerSubscription_2eproto,
    file_level_service_descriptors_CancelScannerSubscription_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_CancelScannerSubscription_2eproto_getter() {
  return &descriptor_table_CancelScannerSubscription_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_CancelScannerSubscription_2eproto(&descriptor_table_CancelScannerSubscription_2eproto);
namespace protobuf {
...
class CancelScannerSubscription::_Internal {
 public:
  using HasBits = decltype(std::declval<CancelScannerSubscription>()._impl_._has_bits_);
...
CancelScannerSubscription::CancelScannerSubscription(const CancelScannerSubscription& from)
  ...
  CancelScannerSubscription* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
const char* CancelScannerSubscription::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* CancelScannerSubscription::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:protobuf.CancelScannerSubscription)
  return target;
}

size_t CancelScannerSubscription::ByteSizeLong() const {
...
void CancelScannerSubscription::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<CancelScannerSubscription*>(&to_msg);
  auto& from = static_cast<const CancelScannerSubscription&>(from_msg);
...
// @@protoc_insertion_point(class_specific_copy_from_start:protobuf.CancelScannerSubscription)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool CancelScannerSubscription::IsInitialized() const {
  return true;
}
...
template<> PROTOBUF_NOINLINE ::protobuf::CancelScannerSubscription*
Arena::CreateMaybeMessage< ::protobuf::CancelScannerSubscription >(Arena* arena) {
  return Arena::CreateMessageInternal< ::protobuf::CancelScannerSubscription >(arena);
}
