...
class PositionsMultiRequest final :
 ...
 public:
  ...
  ~PositionsMultiRequest() override;
  explicit PROTOBUF_CONSTEXPR PositionsMultiRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PositionsMultiRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const PositionsMultiRequest& from) {
    PositionsMultiRequest::MergeImpl(*this, from);
  }
  private:
...
void PositionsMultiRequest::set_account(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PositionsMultiRequest::set_modelcode(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
