...
struct DeltaNeutralContractDefaultTypeInternal {
  PROTOBUF_CONSTEXPR DeltaNeutralContractDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DeltaNeutralContractDefaultTypeInternal _DeltaNeutralContract_default_instance_;
}  // namespace protobuf
static ::_pb::Metadata file_level_metadata_DeltaNeutralContract_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_DeltaNeutralContract_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_DeltaNeutralContract_2eproto = nullptr;

const uint32_t TableStruct_DeltaNeutralContract_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::protobuf::DeltaNeutralContract)},
};
...
const char descriptor_table_protodef_DeltaNeutralContract_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_DeltaNeutralContract_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_DeltaNeutralContract_2eproto = {
    false, false, 230, descriptor_table_protodef_DeltaNeutralContract_2eproto,
    "DeltaNeutralContract.proto",
    &descriptor_table_DeltaNeutralContract_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_DeltaNeutralContract_2eproto::offsets,
    file_level_metadata_DeltaNeutralContract_2eproto, file_level_enum_descriptors_DeltaNeutralContract_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_DeltaNeutralContract_2eproto(&descriptor_table_DeltaNeutralContract_2eproto);
namespace protobuf {
...
DeltaNeutralContract::DeltaNeutralContract(const DeltaNeutralContract& from)
  ...
  DeltaNeutralContract* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  ::memcpy(&_impl_.delta_, &from._impl_.delta_,
...
inline void DeltaNeutralContract::SharedCtor(
