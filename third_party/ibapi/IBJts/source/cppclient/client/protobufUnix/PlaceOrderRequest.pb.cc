...
PROTOBUF_CONSTEXPR PlaceOrderRequest::PlaceOrderRequest(
  ...
  , /*decltype(_impl_.attachedorders_)*/nullptr
...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_PlaceOrderRequest_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_PlaceOrderRequest_2eproto = nullptr;
...
const uint32_t TableStruct_PlaceOrderRequest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::protobuf::PlaceOrderRequest, _impl_.attachedorders_),
  3,
  0,
  1,
  2,
...
const char descriptor_table_protodef_PlaceOrderRequest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_PlaceOrderRequest_2eproto_deps[3] = {
  &::descriptor_table_AttachedOrders_2eproto,
  &::descriptor_table_Contract_2eproto,
  &::descriptor_table_Order_2eproto,
};
static ::_pbi::once_flag descriptor_table_PlaceOrderRequest_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_PlaceOrderRequest_2eproto = {
    false, false, 394, descriptor_table_protodef_PlaceOrderRequest_2eproto,
    ...
    file_level_metadata_PlaceOrderRequest_2eproto, file_level_enum_descriptors_PlaceOrderRequest_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_PlaceOrderRequest_2eproto(&descriptor_table_PlaceOrderRequest_2eproto);
namespace protobuf {
...
PlaceOrderRequest::_Internal::attachedorders(const PlaceOrderRequest* msg) {
  return *msg->_impl_.attachedorders_;
}
...
void PlaceOrderRequest::clear_attachedorders() {
  if (_impl_.attachedorders_ != nullptr) _impl_.attachedorders_->Clear();
...
PlaceOrderRequest::PlaceOrderRequest(const PlaceOrderRequest& from)
  ...
  if (from._internal_has_attachedorders()) {
    _this->_impl_.attachedorders_ = new ::protobuf::AttachedOrders(*from._impl_.attachedorders_);
  }
...
inline void PlaceOrderRequest::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete _impl_.attachedorders_;
}
...
// @@protoc_insertion_point(message_clear_start:protobuf.PlaceOrderRequest)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000004u) {
      GOOGLE_DCHECK(_impl_.attachedorders_ != nullptr);
      _impl_.attachedorders_->Clear();
    }
  }
  _impl_.orderid_ = 0;
...
uint8_t* PlaceOrderRequest::_InternalSerialize(
  ...
  if (_internal_has_attachedorders()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(4, _Internal::attachedorders(this),
        _Internal::attachedorders(this).GetCachedSize(), target, stream);
  }
...
void PlaceOrderRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_mutable_attachedorders()->::protobuf::AttachedOrders::MergeFrom(
          from._internal_attachedorders());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.orderid_ = from._impl_.orderid_;
    }
