...
PROTOBUF_CONSTEXPR OrderState::OrderState(
  ...
  , /*decltype(_impl_.commissionandfeescurrency_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.margincurrency_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.suggestedsize_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.rejectreason_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.warningtext_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.completedtime_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.completedstatus_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_OrderState_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_OrderState_2eproto = nullptr;
...
static ::_pbi::once_flag descriptor_table_OrderState_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_OrderState_2eproto = {
    false, false, 1903, descriptor_table_protodef_OrderState_2eproto,
    "OrderState.proto",
    ...
    file_level_metadata_OrderState_2eproto, file_level_enum_descriptors_OrderState_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_OrderState_2eproto(&descriptor_table_OrderState_2eproto);
namespace protobuf {
...
OrderState::OrderState(const OrderState& from)
  ...
  if (from._internal_has_commissionandfeescurrency()) {
    _this->_impl_.commissionandfeescurrency_.Set(from._internal_commissionandfeescurrency(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_margincurrency()) {
    _this->_impl_.margincurrency_.Set(from._internal_margincurrency(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_suggestedsize()) {
    _this->_impl_.suggestedsize_.Set(from._internal_suggestedsize(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_rejectreason()) {
    _this->_impl_.rejectreason_.Set(from._internal_rejectreason(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_warningtext()) {
    _this->_impl_.warningtext_.Set(from._internal_warningtext(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_completedtime()) {
    _this->_impl_.completedtime_.Set(from._internal_completedtime(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_completedstatus()) {
    _this->_impl_.completedstatus_.Set(from._internal_completedstatus(), 
      _this->GetArenaForAllocation());
  }
...
inline void OrderState::SharedDtor() {
  ...
  _impl_.orderallocations_.~RepeatedPtrField();
...
uint8_t* OrderState::_InternalSerialize(
  ...
  if (_internal_has_initmarginbefore()) {
    ...
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(2, this->_internal_initmarginbefore(), target);
  }

  // optional double maintMarginBefore = 3;
  if (_internal_has_maintmarginbefore()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(3, this->_internal_maintmarginbefore(), target);
  }

  // optional double equityWithLoanBefore = 4;
  if (_internal_has_equitywithloanbefore()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(4, this->_internal_equitywithloanbefore(), target);
  }

  // optional double initMarginChange = 5;
  if (_internal_has_initmarginchange()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(5, this->_internal_initmarginchange(), target);
  }

  // optional double maintMarginChange = 6;
  if (_internal_has_maintmarginchange()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(6, this->_internal_maintmarginchange(), target);
  }

  // optional double equityWithLoanChange = 7;
  if (_internal_has_equitywithloanchange()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(7, this->_internal_equitywithloanchange(), target);
  }

  // optional double initMarginAfter = 8;
  if (_internal_has_initmarginafter()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(8, this->_internal_initmarginafter(), target);
  }

  // optional double maintMarginAfter = 9;
  if (_internal_has_maintmarginafter()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(9, this->_internal_maintmarginafter(), target);
  }

  // optional double equityWithLoanAfter = 10;
  if (_internal_has_equitywithloanafter()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(10, this->_internal_equitywithloanafter(), target);
  }

  // optional double commissionAndFees = 11;
  if (_internal_has_commissionandfees()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(11, this->_internal_commissionandfees(), target);
  }

  // optional double minCommissionAndFees = 12;
  if (_internal_has_mincommissionandfees()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(12, this->_internal_mincommissionandfees(), target);
  }

  // optional double maxCommissionAndFees = 13;
  if (_internal_has_maxcommissionandfees()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(13, this->_internal_maxcommissionandfees(), target);
  }
  ...
  if (_internal_has_initmarginbeforeoutsiderth()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(16, this->_internal_initmarginbeforeoutsiderth(), target);
  }

  // optional double maintMarginBeforeOutsideRTH = 17;
  if (_internal_has_maintmarginbeforeoutsiderth()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(17, this->_internal_maintmarginbeforeoutsiderth(), target);
  }

  // optional double equityWithLoanBeforeOutsideRTH = 18;
  if (_internal_has_equitywithloanbeforeoutsiderth()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(18, this->_internal_equitywithloanbeforeoutsiderth(), target);
  }

  // optional double initMarginChangeOutsideRTH = 19;
  if (_internal_has_initmarginchangeoutsiderth()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(19, this->_internal_initmarginchangeoutsiderth(), target);
  }

  // optional double maintMarginChangeOutsideRTH = 20;
  if (_internal_has_maintmarginchangeoutsiderth()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(20, this->_internal_maintmarginchangeoutsiderth(), target);
  }

  // optional double equityWithLoanChangeOutsideRTH = 21;
  if (_internal_has_equitywithloanchangeoutsiderth()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(21, this->_internal_equitywithloanchangeoutsiderth(), target);
  }

  // optional double initMarginAfterOutsideRTH = 22;
  if (_internal_has_initmarginafteroutsiderth()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(22, this->_internal_initmarginafteroutsiderth(), target);
  }

  // optional double maintMarginAfterOutsideRTH = 23;
  if (_internal_has_maintmarginafteroutsiderth()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(23, this->_internal_maintmarginafteroutsiderth(), target);
  }

  // optional double equityWithLoanAfterOutsideRTH = 24;
  if (_internal_has_equitywithloanafteroutsiderth()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(24, this->_internal_equitywithloanafteroutsiderth(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:protobuf.OrderState)
  ...
  for (const auto& msg : this->_impl_.orderallocations_) {
    total_size +=
...
void OrderState::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.orderallocations_.MergeFrom(from._impl_.orderallocations_);
