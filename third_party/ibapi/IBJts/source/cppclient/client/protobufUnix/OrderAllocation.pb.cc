...
PROTOBUF_CONSTEXPR OrderAllocation::OrderAllocation(
  ...
  , /*decltype(_impl_.positiondesired_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.positionafter_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.desiredallocqty_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.allowedallocqty_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.ismonetary_)*/false} {}
struct OrderAllocationDefaultTypeInternal {
  PROTOBUF_CONSTEXPR OrderAllocationDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 OrderAllocationDefaultTypeInternal _OrderAllocation_default_instance_;
}  // namespace protobuf
static ::_pb::Metadata file_level_metadata_OrderAllocation_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_OrderAllocation_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_OrderAllocation_2eproto = nullptr;
...
const char descriptor_table_protodef_OrderAllocation_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_OrderAllocation_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_OrderAllocation_2eproto = {
    false, false, 432, descriptor_table_protodef_OrderAllocation_2eproto,
    ...
    file_level_metadata_OrderAllocation_2eproto, file_level_enum_descriptors_OrderAllocation_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_OrderAllocation_2eproto(&descriptor_table_OrderAllocation_2eproto);
namespace protobuf {
...
OrderAllocation::OrderAllocation(const OrderAllocation& from)
  ...
  if (from._internal_has_positiondesired()) {
    _this->_impl_.positiondesired_.Set(from._internal_positiondesired(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_positionafter()) {
    _this->_impl_.positionafter_.Set(from._internal_positionafter(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_desiredallocqty()) {
    _this->_impl_.desiredallocqty_.Set(from._internal_desiredallocqty(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_allowedallocqty()) {
    _this->_impl_.allowedallocqty_.Set(from._internal_allowedallocqty(), 
      _this->GetArenaForAllocation());
  }
...
uint8_t* OrderAllocation::_InternalSerialize(
  ...
  if (_internal_has_ismonetary()) {
    ...
    target = ::_pbi::WireFormatLite::WriteBoolToArray(7, this->_internal_ismonetary(), target);
  }
...
void OrderAllocation::InternalSwap(OrderAllocation* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.positiondesired_, lhs_arena,
      &other->_impl_.positiondesired_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.positionafter_, lhs_arena,
      &other->_impl_.positionafter_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.desiredallocqty_, lhs_arena,
      &other->_impl_.desiredallocqty_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.allowedallocqty_, lhs_arena,
